            ...
            <div className="space-y-6">
              <div className="text-center py-8">
                ...
                <p className="text-lg text-foreground/80 leading-relaxed max-w-md mx-auto">
                  You're about to embark on a journey that transforms how
                  finance serves life. Let's discover your unique path in the
                        ...
                        <div className="flex items-center gap-3 mb-2">
                          ...
                          {selectedPersona === persona && (
                            <CheckCircle2
                              className={
                                config.color === "atlas-gold"
                                  ? "w-5 h-5 text-atlas-gold"
                                  : config.color === "atlas-cosmic"
                                    ? "w-5 h-5 text-atlas-cosmic"
                                    : config.color === "atlas-regenerative"
                                      ? "w-5 h-5 text-atlas-regenerative"
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    {question.options.map((option) => (
                      <button
                        key={option.value}
                        onClick={() =>
                          handleValueSelect(question.id, option.value)
                        }
          ...
          {step.id === "complete" && (
            <div className="text-center py-8">
              ...
              <p className="text-lg text-foreground/80 leading-relaxed max-w-md mx-auto mb-6">
                Welcome, {getPersonaConfig(selectedPersona)?.title}! Your
                journey into regenerative finance begins now.
              </p>
              <div className="flex justify-center gap-4">
                <Badge variant="secondary">🌟 Newly Awakened</Badge>
