...
const personaKeywords = {
  custodian: 'ethical investment platforms, impact investing dashboard, regenerative finance tools, conscious capitalism SaaS, wealth management ethics',
  creator: 'AI for art and healing, global wisdom library, crisis into art platform, creative storytelling finance, cultural wisdom',
  regenerator: 'fund my climate project, AI funding platform for NGOs, transparent regenerative capital, planetary healing finance',
  citizen: 'where does my money go map, AI storytelling for the planet, ethical finance map app, conscience capitalism tools'
};
...
const baseStructuredData = {
  ...
  "@type": "Organization",
  "name": "Atlas Sanctum",
  "description": "The world's first platform transforming capital into conscience and wealth into wisdom through regenerative finance.",
...
export default function SEOHead({ 
  ...
  const defaultTitle = "Atlas Sanctum - Capital Becomes Conscience, Wealth Becomes Wisdom";
  const defaultDescription = "Transform finance for planetary healing with the world's first regenerative finance platform. Connect ethical capital to regenerative projects through AI-powered insights and immersive storytelling.";
  const defaultKeywords = "regenerative finance, ethical investing, impact investment platform, conscious capitalism, dignity coin, planetary healing, AI finance, Web3 sustainability";
  
  const finalTitle = title || defaultTitle;
  const finalDescription = description || defaultDescription;
  const finalKeywords = keywords || (persona ? `${defaultKeywords}, ${personaKeywords[persona]}` : defaultKeywords);
  ...
  }, [finalTitle, finalDescription, finalKeywords, finalImage, canonicalUrl, structuredData]);

  return null;
}

// Utility function to generate persona-specific structured data
export function generatePersonaStructuredData(persona: 'custodian' | 'creator' | 'regenerator' | 'citizen') {
  const personaData = {
    custodian: {
      "@type": "SoftwareApplication",
      "applicationCategory": "FinanceApplication",
      "name": "Atlas Sanctum - Ethical Investment Platform",
      "description": "Professional dashboard for ethical capital custodians to redirect investments into regenerative projects with real-time impact analytics.",
      "featureList": [
    ...
    creator: {
      ...
      "description": "AI-powered platform for artists and cultural creators to transform crisis into healing through poetry, music, and wisdom narratives.",
    ...
    regenerator: {
      ...
      "description": "Transparent funding platform connecting planetary regeneration projects with ethical capital through AI-powered matching.",
      ...
      "targetAudience": {
        "@type": "Audience",
        "audienceType": "NGOs, Climate Organizations, Indigenous Communities, Regenerative Projects"
      }
    },
    citizen: {
      "@type": "MobileApplication",
      "name": "Atlas Sanctum - Citizen Conscience App", 
      "description": "Interactive map and tools for citizens to understand financial flows and take micro-actions for planetary healing.",
      "operatingSystem": "Web, iOS, Android",
      "featureList": [
